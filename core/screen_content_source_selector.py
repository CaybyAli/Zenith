...
def select_screen_content_source(job: Any) -> ScreenContentSourceSelection:
    ...
    try:
        ...
        if raw_video_path:
            ...
            if raw_exists:
                return ScreenContentSourceSelection(
            ...
            return ScreenContentSourceSelection(
                status=SCREEN_CONTENT_SOURCE_STATUS_BLOCKED_MISSING_VIDEO_SOURCE,
                selected_path=raw_video_path,
                selected_type=SCREEN_CONTENT_SELECTED_TYPE_RAW_VIDEO_PATH,
                checked_sources=checked_sources,
                source_exists=False,
        ...
        if preprocessing_source_path:
            checked_sources.append(
                _checked_source(
                    source_type=SCREEN_CONTENT_SELECTED_TYPE_PREPROCESSING_SOURCE_PATH,
            ...
            if preprocessing_exists:
                return ScreenContentSourceSelection(
                    status=SCREEN_CONTENT_SOURCE_STATUS_SELECTED_FALLBACK,
                    selected_path=preprocessing_source_path,
                    selected_type=SCREEN_CONTENT_SELECTED_TYPE_PREPROCESSING_SOURCE_PATH,
                    checked_sources=checked_sources,
                    source_exists=True,
                    recommendation="run_screen_content_classification",
        ...
        for field_name in FALLBACK_VIDEO_FIELDS:
            ...
            checked_sources.append(
                _checked_source(
                    source_type=f"{SCREEN_CONTENT_SELECTED_TYPE_FALLBACK_VIDEO_PATH}:{field_name}",
                    path=fallback_path,
            ...
            if fallback_exists:
                return ScreenContentSourceSelection(
                    ...
                    selected_type=SCREEN_CONTENT_SELECTED_TYPE_FALLBACK_VIDEO_PATH,
                    checked_sources=checked_sources,
                    source_exists=True,
                    recommendation="run_screen_content_classification",
        ...
        return ScreenContentSourceSelection(
            status=SCREEN_CONTENT_SOURCE_STATUS_SKIPPED_NO_VIDEO_SOURCE,
            selected_path=None,
            selected_type=SCREEN_CONTENT_SELECTED_TYPE_NONE,
            checked_sources=checked_sources,
            source_exists=False,
            recommendation="provide_video_source",
            warnings=["no_screen_content_video_source_found"],
            errors=[],
            metadata={},
        )
        ...
        return ScreenContentSourceSelection(
            status=SCREEN_CONTENT_SOURCE_STATUS_FAILED,
            selected_path=None,
            selected_type=SCREEN_CONTENT_SELECTED_TYPE_NONE,
            checked_sources=checked_sources,
            source_exists=False,
            ...
            warnings=[],
            errors=[f"screen_content_source_selection_failed: {exc}"],
            metadata={},
        )
