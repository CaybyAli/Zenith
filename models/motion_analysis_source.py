...
MOTION_SOURCE_STATUS_SELECTED = "selected"
MOTION_SOURCE_STATUS_SELECTED_FALLBACK = "selected_fallback"
MOTION_SOURCE_STATUS_SKIPPED_NO_VIDEO_SOURCE = "skipped_no_video_source"
MOTION_SOURCE_STATUS_BLOCKED_MISSING_VIDEO_SOURCE = "blocked_missing_video_source"
MOTION_SOURCE_STATUS_FAILED = "failed"

MOTION_SELECTED_TYPE_RAW_VIDEO_PATH = "raw_video_path"
MOTION_SELECTED_TYPE_PREPROCESSING_SOURCE_PATH = "preprocessing_source_path"
MOTION_SELECTED_TYPE_FALLBACK_VIDEO_PATH = "fallback_video_path"
MOTION_SELECTED_TYPE_NONE = "none"
...
@dataclass
class MotionAnalysisSourceSelection:
    status: str
    selected_path: str | None = None
    selected_type: str | None = MOTION_SELECTED_TYPE_NONE
