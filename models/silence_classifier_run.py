...
class SilenceClassifierRunReport:
    ...
    context_build_result: dict[str, Any] = field(default_factory=dict)
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "context_build_status": self.context_build_status,
            "context_build_result": dict(self.context_build_result),
    ...
    def from_dict(cls, data: dict[str, Any]) -> SilenceClassifierRunReport:
        return cls(
            ...
            context_build_status=data.get("context_build_status"),
            context_build_result=dict(data.get("context_build_result") or {}),
            contexts=list(data.get("contexts") or []),
            context_count=int(data.get("context_count", 0)),
