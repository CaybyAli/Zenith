...
| `scripts/p5_l65_qwen_control_run.py` | Fuehrt den 5D Qwen Kontrollrun aus oder erzeugt ohne Flag einen dry-control-plan. | Lokales Ollama/Qwen nur bei `--enable-local-qwen`; sonst keine Inputs. | `reports/p5_l65_qwen_control_run/` | Nur localhost/127.0.0.1, Qwen analysis_only, can_cut=false, kein Render/Ingest/Musik/Loop. | DONE |
...
P5-L6.5 5D wurde erfolgreich ausgefuehrt. Naechster Schritt ist 5E Abschlussbericht / Final Audit nach Master-GO.
