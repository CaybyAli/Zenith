...
def _demo_segments() -> list[dict]:
    return [
        ...
        {
            "segment_id": "demo_vlog_background_gameplay",
            "start_sec": 8.0,
            "end_sec": 35.0,
        ...
        {
            "segment_id": "demo_funny_gaming_background",
            "start_sec": 35.0,
            "end_sec": 52.0,
            "segment_role": "gameplay",
            "energy_score": 0.45,
        ...
        {
            "segment_id": "demo_suspense_alias_hype",
            "start_sec": 95.0,
            "end_sec": 110.0,
            "segment_role": "gameplay",
            "energy_score": 0.55,
...
def _build_summary(manifest: dict) -> str:
    lines = [
        ...
        f"- allowed_music_categories: {', '.join(manifest['allowed_music_categories'])}",
