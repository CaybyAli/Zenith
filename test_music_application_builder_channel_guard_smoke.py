...
def build_job() -> Job:
    return Job(
        job_id="job_music_application_builder_channel_guard_smoke",
...
def main() -> None:
    ...
    print("MUSIC APPLICATION BUILDER CHANNEL GUARD SMOKE TEST PASSED")
    print({"channel_type": job.channel_type.value, "plan_is_none": plan is None})
