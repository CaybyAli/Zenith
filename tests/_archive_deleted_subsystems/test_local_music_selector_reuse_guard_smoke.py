...
def build_job() -> Job:
    return Job(
        job_id="job_local_music_selector_reuse_guard_smoke",
...
def main() -> None:
    ...
    music_cue_plan = MusicCuePlan(
        plan_id="music_plan_reuse_guard_001",
        job_id=job.job_id,
    ...
    assert len({selection.asset_id for selection in selections}) == 2

    print("LOCAL MUSIC SELECTOR REUSE GUARD SMOKE TEST PASSED")
    print(
        {
